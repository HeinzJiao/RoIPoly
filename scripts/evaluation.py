...
# This block is commented out because we want to use the custom COCO evaluation function
# (from eval_coco import eval_coco) instead of the built-in pycocotools COCO evaluation.
# If you want to use the original COCO evaluation from pycocotools, simply uncomment this block.

...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset-name", type=str, default="aicrowd_train", help="Name of the dataset")
    parser.add_argument("--train-json", type=str,
                        default="../../data/AIcrowd/train/annotation.json",
                        help="Path to the training annotation json file")
    parser.add_argument("--train-path", type=str, default="../../data/AIcrowd/train/images",

...
class DynamicHead(nn.Module):
    ...
    def __init__(self, cfg, roi_input_shape):
        ...
        self.rcnn_head = RCNNHead(d_model, num_classes, num_corners, transformer, num_queries)
...
# TODO: The current class name "RCNNHead" is misleading. It should be renamed to "TransformerHead" in future refactoring.
